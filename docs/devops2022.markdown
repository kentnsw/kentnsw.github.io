...
Often these findings are found too late because the workloads have gone live, or damages have been done. For example, we found $30,000 a month potential cost savings recently, which from one point of view, that’s great. But from another point of view, it would be even better if we can find them earlier.
